# -*- coding: utf-8 -*-
"""
Created on Fri Aug 27 18:36:06 2021
...
class Banco:
    ...
    def menu_caja_ahorro (self):
        ...
        if opcion == "1":
            ...
            if result == 0:    
                ...
                print("")
                self.menu_operar_caja_h()
        elif opcion == "3":
            if self.caja_ahorro == [] and self.caja_ahorro.cliente == []:
                print(self.buscar_ch_de_clientes())
    ...
    def menu_operar_caja_h(self):
           print("""\u001B[32m """)
           print( "***********************************************************")
           print("* ******************************************************* *")
           print(" * *                                                     * * ")
           print("* *             \u001B[37m    Opciones Caja de Ahorro:\u001B[32m                 * *")
           print("* *                                                                              * *")
           print("* *        \u001B[33m 1\u001B[37m - Depositar\u001B[32m                          * *")
           print("* *        \u001B[33m 2\u001B[37m - Extraer\u001B[32m                            * *")
           print("* *        \u001B[33m 3\u001B[37m - Total Saldo\u001B[32m                        * *")
           print("* *        \u001B[33m 0\u001B[37m - Volver al Menu Principal\u001B[32m           * *")
           print("* *                                                                              * *")
           print("* ******************************************************* *")
           print("***********************************************************")
          
           menu_ch = int(input("Digite Opcion: "))
